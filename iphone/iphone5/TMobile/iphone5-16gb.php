...
$_SESSION['sellphone_id'] = "4";
$query = "SELECT * FROM sellphones where sellphone_id = '4'";
...
<div class="well well-sm well1"><a href="../../../sellphone.php">Sell Phone</a> &gt;  <a href="../../../iphone.php"><?php echo $cell_brand;?></a> &gt;  <a href="../../iphone5.php"><?php echo $cell_name;?></a> &gt;  <a href="../Tmobile.php"><?php echo $cell_carrier;?></a> &gt;  <?php echo $cell_capacity;?> GB &gt;</div>
