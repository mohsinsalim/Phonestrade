...
global $con;
//iphone 5 16GB Unlocked Carrier
$_SESSION['sellphone_id'] = "5";
$query = "SELECT * FROM sellphones where sellphone_id = '5'";
...
<div class="well well-sm well1"><a href="../../../sellphone.php">Sell Phone</a> &gt;  <a href="../../../iphone.php"><?php echo $cell_brand;?></a> &gt;  <a href="../../iphone5.php"><?php echo $cell_name;?></a> &gt;  <a href="../Unlocked.php"><?php echo $cell_carrier;?></a> &gt;  <?php echo $cell_capacity;?> GB &gt;</div>
...
<hr>
 <div class="row">
 	<div class="col-sm-1 col-md-2 col-lg-3">
   	<br>
    	<img src="../../../img/iphone5s.jpg" alt="<?php echo $cell_name;?>" width="105" height="200">
    </div>
 ...
 <!--Slide down end-->
 	...
 	<div id="offerContainer" class="container-fluid bg-ghostwhite" style="border:1px double silver; width:85%; padding: 15px;"> 
        ...
        <button id="getPaidkey" style="font-size:20px;" class="btn btn-success btn-lg">Get Paid</button>
        <hr>
    ...
    <div id="gettingEmail" class="container-fluid" style="border:0.5px solid darkgrey; border-top: none; width:85%; padding: 15px; margin-top:0.2px; display:none;">
        ...
        <br>
        <button type="submit" style="font-size:25px;" id="EmailSubmitButton" class="btn btn-success btn-lg">Next Step</button>
        </form>
        <br><br>
...
$( "#getPaidkey" ).click(function() {
	...
	$('html, body').animate({
        scrollTop: $('#slideHere').offset().top
    }, 'slow');
	//End Animation
