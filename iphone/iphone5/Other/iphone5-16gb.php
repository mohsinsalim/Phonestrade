...
global $con;
//iphone 5 16GB Other Carrier
$_SESSION['sellphone_id'] = "6";
$query = "SELECT * FROM sellphones where sellphone_id = '6'";
...
<div class="well well-sm well1"><a href="../../../sellphone.php">Sell Phone</a> &gt;  <a href="../../../iphone.php"><?php echo $cell_brand;?></a> &gt;  <a href="../../iphone5.php"><?php echo $cell_name;?></a> &gt;  <a href="../Other.php"><?php echo $cell_carrier;?></a> &gt;  <?php echo $cell_capacity;?> GB &gt;</div>
