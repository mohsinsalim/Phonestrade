...
global $con;
//iphone X 64GB Other Carrier
$_SESSION['sellphone_id'] = "234";
$query = "SELECT * FROM sellphones where sellphone_id = '234'";
...
<div class="well well-sm well1"><a href="../../../sellphone.php">Sell Phone</a> &gt;  <a href="../../../iphone.php"><?php echo $cell_brand;?></a> &gt;  <a href="../../iphoneX.php"><?php echo $cell_name;?></a> &gt;  <a href="../OtherCarrier.php"><?php echo $cell_carrier;?></a> &gt;  <?php echo $cell_capacity;?> GB</div>
...
<hr>
 <div class="row">
 	<div class="col-sm-1 col-md-2 col-lg-3">
   	<br>
    	<img src="../../../img/iphoneXcondition.jpg" alt="<?php echo $cell_name;?>">
    </div>
