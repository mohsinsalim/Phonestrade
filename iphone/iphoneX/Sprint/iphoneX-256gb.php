...
global $con;
//iphone X 256GB SPRINT
$_SESSION['sellphone_id'] = "229";
$query = "SELECT * FROM sellphones where sellphone_id = '229'";
...
<div class="well well-sm well1"><a href="../../../sellphone.php">Sell Phone</a> &gt;  <a href="../../../iphone.php"><?php echo $cell_brand;?></a> &gt;  <a href="../../iphoneX.php"><?php echo $cell_name;?></a> &gt;  <a href="../sprint.php"><?php echo $cell_carrier;?></a> &gt;  <?php echo $cell_capacity;?> GB</div>
