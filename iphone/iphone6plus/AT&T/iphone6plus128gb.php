...
global $con;
//iphone 6 PLUS 128GB AT&T
$_SESSION['sellphone_id'] = "52";
$query = "SELECT * FROM sellphones where sellphone_id = '52'";
...
<div class="well well-sm well1"><a href="../../../sellphone.php">Sell Phone</a> &gt;  <a href="../../../iphone.php"><?php echo $cell_brand;?></a> &gt;  <a href="../../iphone6plus.php"><?php echo $cell_name;?></a> &gt;  <a href="../att.php"><?php echo $cell_carrier;?></a> &gt;  <?php echo $cell_capacity;?> GB</div>
