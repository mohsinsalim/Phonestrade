...
global $con;
//iphone 8 256GB T-Mobile
$_SESSION['sellphone_id'] = "207";
$query = "SELECT * FROM sellphones where sellphone_id = '207'";
...
<div class="well well-sm well1"><a href="../../../sellphone.php">Sell Phone</a> &gt;  <a href="../../../iphone.php"><?php echo $cell_brand;?></a> &gt;  <a href="../../iphone8.php"><?php echo $cell_name;?></a> &gt;  <a href="../tmobile.php"><?php echo $cell_carrier;?></a> &gt;  <?php echo $cell_capacity;?> GB</div>
