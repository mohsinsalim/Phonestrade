...
global $con;
//iphone 8 256GB Other Carrier
$_SESSION['sellphone_id'] = "211";
$query = "SELECT * FROM sellphones where sellphone_id = '211'";
...
<div class="well well-sm well1"><a href="../../../sellphone.php">Sell Phone</a> &gt;  <a href="../../../iphone.php"><?php echo $cell_brand;?></a> &gt;  <a href="../../iphone8.php"><?php echo $cell_name;?></a> &gt;  <a href="../OtherCarrier.php"><?php echo $cell_carrier;?></a> &gt;  <?php echo $cell_capacity;?> GB</div>
...
<hr>
 <div class="row">
 	<div class="col-sm-1 col-md-2 col-lg-3">
   	<br>
    	<img src="../../../img/iphone8condition.jpg" alt="<?php echo $cell_name;?>">
    </div>
