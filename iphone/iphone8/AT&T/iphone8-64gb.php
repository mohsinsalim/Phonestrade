...
global $con;
//iphone 8 64GB AT&T
$_SESSION['sellphone_id'] = "202";
$query = "SELECT * FROM sellphones where sellphone_id = '203'";
...
<div class="well well-sm well1"><a href="../../../sellphone.php">Sell Phone</a> &gt;  <a href="../../../iphone.php"><?php echo $cell_brand;?></a> &gt;  <a href="../../iphone8.php"><?php echo $cell_name;?></a> &gt;  <a href="../att.php"><?php echo $cell_carrier;?></a> &gt;  <?php echo $cell_capacity;?> GB</div>
