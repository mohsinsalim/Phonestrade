...
global $con;
//iphone 5C 32GB Verizon
$_SESSION['sellphone_id'] = "12";
$query = "SELECT * FROM sellphones where sellphone_id = '12'";
...
<div class="well well-sm well1"><a href="../../../sellphone.php">Sell Phone</a> &gt;  <a href="../../../iphone.php"><?php echo $cell_brand;?></a> &gt;  <a href="../../iphone5c.php"><?php echo $cell_name;?></a> &gt;  <a href="../verizon.php"><?php echo $cell_carrier;?></a> &gt;  <?php echo $cell_capacity;?> GB</div>
...
<hr>
 <div class="row">
 	<div class="col-sm-1 col-md-2 col-lg-3">
   	<br>
    	<img src="../../../img/iphone5c.jpg" alt="<?php echo $cell_name;?>" width="105" height="200">
    </div>
