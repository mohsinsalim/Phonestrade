...
<head>
<meta charset="utf-8">
<title>Phones Trade - REGISTRATION PAGE, PLEASE REGISTER HERE</title>
...
<script>
	function noInputfunction() {
		document.getElementById("missingInputsLabel").style.display = "";	
	}
	
	function missMatchPass() {
		document.getElementById("unmatchPassword").style.display = "";
	}
	...
	$(document).ready(function() {
        $("#signUpButton").click(function() {
			...
			$.ajax({
				...
				url: 'user/signup.php',
				data: {name:fname, email:email, pass:pass, cpass:cpass, cellphone:cellphone},
				type: 'POST',
...
<div class="container-fluid text-center container_1">
	<h2 style="font-family: 'Maven Pro', sans-serif;">User Registration</h2><br>
	...
	<form>
        ...
        <div class="form-group">
        	<input id="name" name="name" style="width:300px; margin:0 auto; font-size:16px;" type="text" class="form-control input-lg" placeholder="Full name">
        </div>
        <div class="form-group">
        	<input id="email" name="email" style="width:300px; margin:0 auto; font-size:16px;" type="email" class="form-control input-lg" placeholder="Email address">
        </div>
        <div class="form-group">
        	<input id="pass" name="pass" style="width:300px; margin:0 auto; font-size:16px;" type="password" class="form-control input-lg" placeholder="Password">
        </div>
        <div class="form-group">
        	<input id="cpass" name="cpass" style="width:300px; margin:0 auto; font-size:16px;" type="password" class="form-control input-lg" placeholder="Confirm password">
        </div>
        <div class="form-group">
        	<input id="cellphone" name="cellphone" style="width:300px; margin:0 auto; font-size:16px;" type="text" class="form-control input-lg" placeholder="Mobile number">
        </div>

        <button id="signUpButton" name="signUpButton" style="width:280px;" type="button" class="btn btn-success btn-lg">Sign up</button>
