...
global $con;
//Samsung Note 5
$_SESSION['sellphone_id'] = "242";
$query = "SELECT * FROM sellphones where sellphone_id = '242'";
...
<div class="well well-sm well1"><a href="../../sellphone.php">Sell Phone</a> &gt;  <a href="../../samsung.php"><?php echo $cell_brand;?></a> &gt; <a href="../verizon.php"><?php echo $cell_carrier;?></a> &gt;  <a href="Note5.php"><?php echo $cell_name;?> <?php echo $cell_capacity;?> GB</a></div>
...
<hr>
 <div class="row">
 	<div class="col-sm-1 col-md-2 col-lg-3">
   	<br>
    	<img src="../../img/SamsungNote5condition.jpg" alt="<?php echo $cell_name;?>">
    </div>
